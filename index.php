...
<html lang="en">
    ...
    <body>
        <div class="gm4html5_div_class" id="gm4html5_div_id">
            <img src="FlappyTappy/splash.png" id="GM4HTML5_loadingscreen" alt="Loading Flappy Tappy" style="display:none;"/>
        ...
        <script type="text/javascript" src="FlappyTappy/index.js?VEVAC=1900891899"></script>
    </body>
</html>
